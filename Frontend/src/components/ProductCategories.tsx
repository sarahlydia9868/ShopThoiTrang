      ...
      <div className="container mx-auto my-28">
        ...
        <div className=" flex justify-center items-center  mt-8 ">
          ...
          >
            <SwiperSlide>
              <ProductedBox
                bgUrl="/images/product/productCategory1.jpeg"
                title="Đầm"
                path="/shop-dam"
              />
            </SwiperSlide>
            <SwiperSlide>
              <ProductedBox
                bgUrl="/images/product/productCategory2.jpeg"
                title="Áo"
                path="/shop-ao"
              />
            </SwiperSlide>
            <SwiperSlide>
              <ProductedBox
                bgUrl="/images/product/productCategory3.jpeg"
                title="Quần"
                path="/shop-quan"
              />
            </SwiperSlide>
            <SwiperSlide>
              <ProductedBox
                bgUrl="/images/product/productCategory4.jpeg"
                title="Chân Váy"
                path="/shop-chan-vay"
              />
            </SwiperSlide>
            <SwiperSlide>
              <ProductedBox
                bgUrl="/images/product/productCategory5.jpeg"
                title="Áo Khoác"
                path="/shop-ao-khoac"
              />
            </SwiperSlide>
