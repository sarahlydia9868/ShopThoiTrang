...
export default function CartBox({ name, price, counter, images }: ICart) {
  return (
    <tbody>
      <tr className=" border-y-1 border-stone-300 hover:shadow-lg shadow-secondary transition-shadow duration-500 ">
        <th
          scope="row"
          className="flex justify-start items-center gap-3 text-start px-6 py-4"
        >
        ...
        <td className="  py-4 text-center">{counter}</td>
