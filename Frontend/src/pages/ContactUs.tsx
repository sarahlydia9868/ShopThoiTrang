      ...
      <div className=" flex justify-between items-start flex-col-reverse xl:flex-row  container mx-auto w-full xl:px-20 py-16">
        <div className="flex justify-center items-center xl:items-start flex-col  px-8 w-full">
          ...
          <div className="flex flex-col gap-5 bg-zinc-900 text-white p-12 w-full  xl:w-[30rem]  rounded-3xl">
            ...
            />
            <Button
              padding=" p-3 w-full text-center"
              text="Submit"
              bgColor="white"
            />
          </div>
        ...
        <div className=" relative w-full">
          <img
            ...
            alt="map"
            className=" xl:scale-150 xl:translate-x-36  xl:mt-16 select-none z-50"
          />
          <label
            htmlFor="usa"
            className={`p-1 rounded-full ${
              selectCountry === "usa" && "animate-ping bg-rose-600 p-1.5"
            } bg-black  absolute left-14 top-14 md:left-20 md:top-24 lg:left-20 lg:top-24 cursor-pointer`}
          >
            <input
              type="radio"
              value="usa"
              ...
              className=" hidden "
              onClick={(e) =>
                setSelectCountry((e.target as HTMLInputElement).value)
              }
            />
          </label>
          <label
            htmlFor="rus"
            className={`p-1 rounded-full ${
              selectCountry === "rus" && "animate-ping bg-rose-600 p-1.5"
            }  bg-black absolute right-44 top-10 xl:right-0 cursor-pointer`}
          >
            <input
              type="radio"
              value="rus"
          ...
          <label
            htmlFor="africa"
            className={`p-1 rounded-full ${
              selectCountry === "afr" && "animate-ping bg-rose-600 p-1.5"
            }  bg-black absolute right-72 bottom-32 md:right-96 md:bottom-48 lg:right-[35rem] lg:bottom-64 xl:right-36 xl:bottom-32 cursor-pointer`}
          >
            <input
              type="radio"
              value="afr"
        ...
        <div className="hidden md:block text-center absolute xl:-right-40 right-5 -bottom-32 -z-10 ">
          <span className=" text-[12rem] text-white drop-shadow-lg font-bold ">
            Contact US
          </span>
        </div>
      </div>
